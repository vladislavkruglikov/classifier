...
BASKETBALL_ITEMS = [
'нба','баскетбол','nba','лейкерс','proбаскет','джа','карри','mavs','пистонс','никс',
'голден','леброн','стэйт','майами','буллс','баскетбола','селтикс',
'уэстбрук','грин','леброна','хит','нетс','гриззлис',
'милуоки','баскетбольный','клипперс','бостон','кайри','энтони','торонто','джордан',
'баскетбольные','подбора','грина','яннис','далласа','матч','cavs','basket',
'тандер','бруклин','джеймс','финикс','трехочковых','матча','уорриорз','чикаго','данк','коби',
'кольцо','даллас','харден','уэйд','чикагобуллс','рокетс','заявил','мемфис',
'бросок','клэй','дончич','джей','лука','кевин','лаури','расселл','беверли','стеф','томпсон','джейлен','леброном',
]
WINTER_SPORT_ITEMS = [
